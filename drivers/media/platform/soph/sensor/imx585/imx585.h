...
static s64 imx585_link_cif_menu[MAX_SENSOR_DEVICE][SNS_CFG_TYPE_MAX] = {
	{//s0 linear mode
		SNS_CFG_TYPE_MAX,
...
static const struct imx585_reg mode_3856x2180_regs[] = {
	{0x3000, 0x01}, // STANDBY
	{0x3001, 0x00}, // XTMSTA
	{0x3002, 0x01},// BCWAIT_TIME[7:0]
	{0x3014, 0x01},// CPWAIT_TIME[7:0]
	{0x3015, 0x05},// HMAX[15:0]
	{0x3018, 0x10},//
	{0x301A, 0x00},// INCKSEL 1[8:0]
	{0x301B, 0x00},// INCKSEL2[1:0]
	{0x301C, 0x00},// INCKSEL4[1:0]
	{0x301E, 0x01},// SYS_MODE
	{0x3020, 0x00},// XVS_DRV[1:0]
	{0x3021, 0x00},// -
	{0x3022, 0x02},// -
	{0x3023, 0x01},// -
	{0x3024, 0x00},// -
	...
	{0x3400, 0x01},// -
	{0x3460, 0x21},// -
	{0x3478, 0xA1},// TCLKPOST[15:0]
	{0x347C, 0x01},// TCLKPREPARE[15:0]
	{0x3480, 0x01},// TCLKTRAIL[15:0]
	{0x36D0, 0x00},// TCLKZERO[15:0]
	{0x36D1, 0x10},// THSPREPARE[15:0]
	{0x36D4, 0x00},// THSZERO[15:0]
	{0x36D5, 0x10},// THSTRAIL[15:0]
	{0x36E2, 0x00},// THSEXIT[15:0]
	{0x36E4, 0x00},// TLPX[15:0]
	{0x36E5, 0x00},// -
	{0x36E6, 0x00}, // STANDBY
	{0x36E8, 0x00}, // XTMSTA
	{0x36E9, 0x00},// BCWAIT_TIME[7:0]
	{0x36EA, 0x00},// CPWAIT_TIME[7:0]
	{0x36EC, 0x00},// HMAX[15:0]
	{0x36EE, 0x00},//
	{0x36EF, 0x00},// INCKSEL 1[8:0]
	{0x3930, 0x0C},// INCKSEL2[1:0]
	{0x3931, 0x01},// INCKSEL4[1:0]
	{0x3A4C, 0x39},// SYS_MODE
	{0x3A4D, 0x01},// XVS_DRV[1:0]
	{0x3A4E, 0x14},// -
	{0x3A50, 0x48},// -
	{0x3A51, 0x01},// -
	{0x3A52, 0x14},// -
	...
	{0x428C, 0xB4},// -
	{0x428E, 0xB6},// -
	{0x4708, 0x00},// TCLKPOST[15:0]
	{0x4709, 0x00},// TCLKPREPARE[15:0]
	{0x470A, 0xFF},// TCLKTRAIL[15:0]
	{0x470B, 0x03},// TCLKZERO[15:0]
	{0x470C, 0x00},// THSPREPARE[15:0]
	{0x470D, 0x00},// THSZERO[15:0]
	{0x470E, 0xFF},// THSTRAIL[15:0]
	{0x470F, 0x03},// THSEXIT[15:0]
	{0x47EB, 0x1C},// TLPX[15:0]
	{0x47F0, 0xA6},// -
	{0x47F2, 0xA6}, // STANDBY
	{0x47F4, 0xA0}, // XTMSTA
	{0x47F6, 0x96},// BCWAIT_TIME[7:0]
	{0x4808, 0xA6},// CPWAIT_TIME[7:0]
	{0x480A, 0xA6},// HMAX[15:0]
	{0x480C, 0xA0},//
	{0x480E, 0x96},// INCKSEL 1[8:0]
	{0x492C, 0xB2},// INCKSEL2[1:0]
	{0x4930, 0x03},// INCKSEL4[1:0]
	{0x4932, 0x03},// SYS_MODE
	{0x4936, 0x5B},// XVS_DRV[1:0]
	{0x4938, 0x82},// -
	{0x493C, 0x23},// -
	{0x493E, 0x23},// -
	{0x4940, 0x23},// -
	...
	{0x4F3A, 0x3C},// -
	{0x4F3C, 0x46},// -
	{0x4F3E, 0x59},// TCLKPOST[15:0]
	{0x4F42, 0x64},// TCLKPREPARE[15:0]
	{0x4F44, 0x6E},// TCLKTRAIL[15:0]
	{0x4F46, 0x81},// TCLKZERO[15:0]
	{0x4F4A, 0x82},// THSPREPARE[15:0]
	{0x4F5A, 0x81},// THSZERO[15:0]
	{0x4F62, 0xAA},// THSTRAIL[15:0]
	{0x4F72, 0xA9},// THSEXIT[15:0]
	{0x4F78, 0x36},// TLPX[15:0]
	{0x4F7A, 0x41},// -
	{0x4F7C, 0x61}, // STANDBY
	{0x4F7D, 0x01}, // XTMSTA
	{0x4F7E, 0x7C},// BCWAIT_TIME[7:0]
	{0x4F7F, 0x01},// CPWAIT_TIME[7:0]
	{0x4F80, 0x77},// HMAX[15:0]
	{0x4F82, 0x7B},//
	{0x4F88, 0x37},// INCKSEL 1[8:0]
	{0x4F8A, 0x40},// INCKSEL2[1:0]
	{0x4F8C, 0x62},// INCKSEL4[1:0]
	{0x4F8D, 0x01},// SYS_MODE
	{0x4F8E, 0x76},// XVS_DRV[1:0]
	{0x4F8F, 0x01},// -
	{0x4F90, 0x5E},// -
	{0x4F91, 0x02},// -
	{0x4F92, 0x69},// -
...
static const struct imx585_reg mode_3856x2180_wdr_regs[] = {
	{0x3000, 0x01},  // STANDBY
	{0x3001, 0x00},  // REGHOLD
	{0x3002, 0x01},  // XMSTA
	...
	{0x3050, 0x8C},  // SHR0[19:0]
	{0x3051, 0x0A},  // SHR0[19:0]

...
} vi_dma_buf_info, vi_cmdq_buf_info[ISP_PRERAW_MAX],
	yuv_dump_vb_info, raw_dump_vb_info[2];

struct _membuf {
	uint64_t splt_le[OFFLINE_RAW_BUF_NUM];
	uint64_t splt_se[OFFLINE_RAW_BUF_NUM];
